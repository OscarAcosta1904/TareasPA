...
class Tienda:
    ...
    def __init__(self) -> None:
        jitomate = Producto(id="123", nombre="Jitomates", precio=50, cantidad=6)
        ...
        self.lista_productos.append(jitomate)
        self.lista_productos.append(lechuga)
        self.lista_productos.append(squirt)
        self.lista_productos.append(chocolate)
